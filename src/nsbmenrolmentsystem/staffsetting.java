 ...
 * @author User
 */
public class staffsetting extends javax.swing.JFrame {

    /**
     * Creates new form staffsetting
     */
    public staffsetting() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(staffsetting.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new staffsetting().setVisible(true);
            }
        });
    }
